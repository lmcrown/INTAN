...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% JP EDIT
% for processing dual recording after splitting into individual animals
if exist('Dual_recording','file')
IX = cellfun(@(x) ~isempty(find_files(['*' x '*'])),{IF.amplifier_channels(:).native_channel_name},'UniformOutput',false);
IX = cell2mat(IX)'; LFP_Chs = LFP_Chs(IX);
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
